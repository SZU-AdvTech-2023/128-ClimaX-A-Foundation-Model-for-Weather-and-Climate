...
#our model
from climax.seri_arch import ClimaX
...
class GlobalForecastModule(LightningModule):
    ...
    def __init__(
        ...
        #             nn.init.kaiming_normal_(parameter.weight, mode='fan_out', nonlinearity='leaky_relu')
        # #           nn.init.xavier_uniform_(m.weight)
        #             parameter.bias.data.fill_(0)
                
        #         parameter.requires_grad = True
        #     elif 'CLimax_Decoder' in name:
        #         parameter.requires_grad = True
        #self.automatic_optimization = False


        # torch.nn.utils.clip_grad_norm_(self.net.parameters(), max_norm=1.0)
        # for m in self.net.head.modules():
    ...
    #     print("")
    #     self.clip_gradients(
    #         optimizer,
